...
const Page2 = () => {
    ...
    return (
        <div id="section2" className="bg-[#f8f9fa] text-gray-800 p-16 overflow-hidden relative flex flex-col items-center">
            ...
            <div className="absolute inset-0 overflow-hidden">
                <div className="absolute top-1/4 left-1/4 w-32 h-32 bg-black/5 rounded-full blur-3xl animate-pulse"></div>
                <div className="absolute bottom-1/4 right-1/4 w-32 h-32 bg-black/5 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '1s' }}></div>
            </div>

            <div className="relative z-10 text-center w-full">
                <h3 className="text-gray-600 text-xl font-[anzo3] text-center tracking-wider">© anzo.studio 2025 | designed and developed</h3>
                <div className="mt-10 rotateText">
                    <h1 className="text-[12vw] text-black font-[anzo2] uppercase leading-[13vw] tracking-tighter hover:tracking-wide transition-all duration-200">IMPACTFUL</h1>
                </div>
                <div className="rotateText">
                    <h1 className="text-[12vw] text-black font-[anzo2] uppercase leading-[13vw] tracking-tighter hover:tracking-wide transition-all duration-300">design</h1>
                </div>
                <div className="rotateText">
                    <h1 className="text-[12vw] text-black font-[anzo2] uppercase leading-[13vw] tracking-tighter hover:tracking-wide transition-all duration-400">is the</h1>
                </div>
                <div className="rotateText">
                    <h1 className="text-[12vw] text-black font-[anzo2] uppercase leading-[13vw] tracking-tighter hover:tracking-wide transition-all duration-500">design</h1>
                </div>
                <div className="rotateText">
                    <h1 className="text-[12vw] text-black font-[anzo2] uppercase leading-[13vw] tracking-tighter hover:tracking-wide transition-all duration-800">that</h1>
                </div>
                <div className="rotateText">
                    <h1 className="text-[12vw] text-black font-[anzo2] uppercase leading-[13vw] tracking-tighter hover:tracking-wide transition-all duration-1000">works!</h1>
                </div>
            </div>

            {/* Logo Section */}
            <div className='flex items-center justify-center scale-60 h-[16vh] w-[120vw]'>
  ...
            </div>
            {/* Remove the Icons Section since it's not in the reference image */}
            <div className="h-0.5 mt-12 relative w-1/3 bg-black"></div>
        </div>
    )}
