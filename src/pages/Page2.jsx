        ...
        <div id="section2" className="bg-[#f8f9fa] text-gray-800 p-16 overflow-hidden relative flex flex-col items-center">
            ...
            <div className="relative z-10 text-center w-full">
                ...
                <div className="mt-10 rotateText">
                    <h1 className="text-[18vw] text-black font-[anzo2] uppercase leading-[20vw] tracking-tighter hover:tracking-wide transition-all duration-300">IMPACTFUL</h1>
                </div>
                <div className="rotateText">
                    <h1 className="text-[18vw] text-black font-[anzo2] uppercase leading-[20vw] tracking-tighter hover:tracking-wide transition-all duration-300">design</h1>
                </div>
                <div className="rotateText">
                    <h1 className="text-[18vw] text-black font-[anzo2] uppercase leading-[20vw] tracking-tighter hover:tracking-wide transition-all duration-300">is the</h1>
                </div>
                <div className="rotateText">
                    <h1 className="text-[18vw] text-black font-[anzo2] uppercase leading-[20vw] tracking-tighter hover:tracking-wide transition-all duration-300">design</h1>
                </div>
                <div className="rotateText">
                    <h1 className="text-[18vw] text-black font-[anzo2] uppercase leading-[20vw] tracking-tighter hover:tracking-wide transition-all duration-300">that</h1>
                </div>
                <div className="rotateText">
                    <h1 className="text-[18vw] text-black font-[anzo2] uppercase leading-[20vw] tracking-tighter hover:tracking-wide transition-all duration-300">works!</h1>
                </div>
            </div>

            <div className="flex justify-center items-center scale-70 mt-12">
                <svg preserveAspectRatio="xMidYMid meet" data-bbox="4 0 2028.339 83" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 2037 91" height="91" width="2037" data-type="ugc" role="img" className="fill-black">
    <g>
        ...
        <defs fill="none">
            ...
            <div className="h-0.5 mt-12 relative w-1/3 bg-gradient-to-r from-cyan-400 to-cyan-600"></div>
        </div>
    )}
